...
- **[AntLing Design Lab](https://github.com/joeynyc/antling-design-lab)** — Generate designs, split them into transparent layers, and finish graphics with editable text using two 6B Ming-Image models on one DGX Spark. `Python` `FastAPI` `Ming-Image`
